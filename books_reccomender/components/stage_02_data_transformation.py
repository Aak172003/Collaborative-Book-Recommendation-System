...
from books_reccomender.config.configuration import AppConfiguration
...
class DataTransformation:
    ...
    def get_data_transformer(self):
        try:
            ...
            logging.info(
                f"Saved pivot table data to {self.data_transformation_config.transformed_data_dir}"
            )
            ...
            logging.info(
                f"Saved book_names serialization object to {self.data_validation_config.serialized_objects_dir}"
            )
            ...
            logging.info(
                f"Saved book_pivot serialization object to {self.data_validation_config.serialized_objects_dir}"
            )
